          ...
          <el-card style="margin-top: 20px" shadow="hover" v-if="CommentP">
            <div>
              <el-form :model="Form" :rules="rule" ref="Form">
                <el-row>
                  <el-col span="2">
                    <img :src="'http://175.24.74.107:8080'+headSrc" class="commentHead" />
                  </el-col>
                  <el-col span="22">
              ...
              <li v-for="(item,index) in commentItem" :key="index">
                <div style="width: 100%;float: left">
                  <span style="width: 8.3%; float: left">
                    <img :src="'http://175.24.74.107:8080'+item.profileUrl" class="commentHead"  @click="intoPage(item)" />
                  </span>
...
export default {
  ...
  methods: {
    ...
    intoPage(item){
      ...
      axios.post("http://175.24.74.107:8081/user/getUserByName", item.userName)
        .then(function (response) {
          console.log("对了");
